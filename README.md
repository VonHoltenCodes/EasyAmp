...
| 🖥️ **Windows 98 SE / XP** (Retro) | **[Installer (.exe)](https://github.com/VonHoltenCodes/EasyAmp/releases/download/retro-v0.4.2/EasyAmp-Retro-Setup.exe)** · [Portable (.zip)](https://github.com/VonHoltenCodes/EasyAmp/releases/download/retro-v0.4.2/EasyAmp-retro-portable.zip) | A separate native client for old PCs: Pentium II and up, 16 colours and up, streams from Plex and Jellyfin. From the old PC itself, open `http://dl.easyampstereo.com/retro/`. See [`retro/`](retro/README.md) |
