/* GENERATED by brssl ta - trust anchors for plex.tv and *.plex.direct.
 * DigiCert Global Root G2 is what plex.tv chains to today; the others are
 * the roots it is most likely to move to. Regenerate: make anchors */
